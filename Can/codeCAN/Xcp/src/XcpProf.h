...
/*------------------------------------------------------------------------*/
/* Pages (WORKING PAGE, REFERENCE PAGE) */

#if defined (XCP_ENABLE_CALIBRATION_PAGE)
#define XCP_WORKING_PAGE   					0x00u
#define XCP_REFERENCE_PAGE 					0x01u

#define XCP_SEGMENT_DEFAULT 					0x00u
#endif
...
/* Used only, if read protection of memory areas is required */
  ...
  #else
extern uint8 ApplXcpCheckReadAccess( MEMORY_ROM MTABYTEPTR address, vuint16 size );
  #endif
#endif
