...
/*----------------------------------------------------------------------------
 ...
 #if defined DRVCAN_TRICOREMULTICANHLL_VERSION
  #if(( DRVCAN_TRICOREMULTICANHLL_VERSION == _DRVCAN_HW_VERSION ) && ( DRVCAN_TRICOREMULTICANHLL_RELEASE_VERSION == _DRVCAN_HW_RELEASE_VERSION ))
...
/*----------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------*/
#if defined( C_COMP_TASKING_TRICORE_MULTICAN )
 #if( VSTDLIB_TRICORE_VERSION != _VSTDLIB_HW_VERSION )
  #error "VStdLib: Wrong main/sub version detected for this SIP delivery!"
 #endif
 #if( VSTDLIB_TRICORE_RELEASE_VERSION != _VSTDLIB_HW_RELEASE_VERSION )
